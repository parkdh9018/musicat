...
public interface AlertRepository extends JpaRepository<Alert, Long> {
    ...
    public Page<Alert> findAllByUserSeqAndAlertTitleContainingOrAlertContentContaining(long userSeq, String alertTitle, String alertContent, Pageable pageable);
